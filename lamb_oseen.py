...
vortices = [
    {'strength':  5.0, 'x':  0.0, 'y':  0.0, 'r0': 0.05, 'aspect_x': 1.5, 'aspect_y': 0.7},
    {'strength': -4.0, 'x': -0.8, 'y':  0.3, 'r0': 0.05, 'aspect_x': 1.0, 'aspect_y': 1.0},
    {'strength':  3.0, 'x':  1.0, 'y': -0.2, 'r0': 0.05, 'aspect_x': 0.6, 'aspect_y': 1.4},
]
...
def velocity_field(t_val, px=None, py=None):
    ...
    for vp in vortices:
        ...
        ay = vp['aspect_y']
        dx = X - vp['x'];  dy = Y - vp['y']
        # Elliptical distance: stretches the vortex shape along x and y independently
...
def draw_frame(u_g, v_g):
    ...
    for vp in vortices:
        ...
        a = r_c * vp['aspect_x']   # x semi-axis
        b = r_c * vp['aspect_y']   # y semi-axis
